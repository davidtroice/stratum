...
const ORG_URLS = {
  "Casa Wabi":                    "https://casawabi.org",
  "FONCA":                        "https://fonca.cultura.gob.mx",
  "Fundación Jumex":              "https://fundacionjumex.org",
  "Artpace":                      "https://artpace.org",
  "Headlands Center for the Arts":"https://headlands.org",
  "Yaddo":                        "https://yaddo.org",
  "Bemis Center for Contemporary Arts":"https://bemiscenter.org",
  "Vermont Studio Center":        "https://vermontstudiocenter.org",
  "Rauschenberg Foundation":      "https://rauschenbergfoundation.org",
  "Künstlerhaus Bethanien":       "https://bethanien.de",
  "Gasworks":                     "https://gasworks.org.uk",
  "Palais de Tokyo":              "https://palaisdetokyo.com",
  "Iaspis":                       "https://iaspis.se",
  "Residency Unlimited":          "https://residencyunlimited.org",
  "Capacete":                     "https://capacete.net",
  "Joan Mitchell Foundation":     "https://joanmitchellfoundation.org",
  "Mondriaan Fund":               "https://mondriaanfonds.nl",
  "Camargo Foundation":           "https://camargofoundation.org",
  "Jerwood Arts":                 "https://jerwoodarts.org",
  "Frieze":                       "https://frieze.com",
  "SP-Arte":                      "https://sp-arte.com",
  "arteBA":                       "https://arteba.org",
  "ARTBO":                        "https://artbo.co",
  "Museo Tamayo":                 "https://museotamayo.org",
  "BIENALSUR":                    "https://bienalsur.org",
  "Sharjah Art Foundation":       "https://sharjahart.org",
  "Gwangju Biennale Foundation":  "https://gwangjubiennale.org",
  "Guggenheim Foundation":        "https://gf.org",
  "Creative Capital":             "https://creative-capital.org",
  "Khoj":                         "https://khojstudios.org",
  "Prince Claus Fund":            "https://princeclausfund.org",
  "ZONAMACO":                     "https://zonamaco.com",
  "Fundação Bienal":              "https://bienal.org.br",
  "Rencontres d'Arles":           "https://rencontres-arles.com",
  "documenta GmbH":               "https://documenta.de",
  "Fondazione Palazzo Magnani":   "https://palazzomagnani.it",
  "Ruya Foundation":              "https://ruyafoundation.org",
  "Red Gate Gallery":             "https://redgategallery.com",
};
...
const OPPORTUNITIES = [
  ...
  { id:11, type:"grant",      name:"FONCA Jóvenes Creadores", org:"FONCA", city:"CDMX", country:"México", region:"mexico", duration:"1 year", stipend:true, fee:false, disciplines:["all"], levels:[1,2,3], deadline:"Mar 2026", description:"Mexico's most important grant for emerging artists under 35. Monthly stipend plus production support.", url:"https://fonca.cultura.gob.mx" },
  { id:12, type:"grant",      name:"FONCA Sistema Nacional de Creadores", org:"FONCA", city:"CDMX", country:"México", region:"mexico", duration:"3 years", stipend:true, fee:false, disciplines:["all"], levels:[3,4,5], deadline:"Rolling", description:"Triennial grant for established Mexican artists. Major institutional recognition and significant stipend.", url:"https://fonca.cultura.gob.mx" },
  ...
  { id:18, type:"grant",      name:"Festival FEMSA", org:"FEMSA", city:"Monterrey", country:"México", region:"mexico", duration:"Variable", stipend:true, fee:false, disciplines:["all"], levels:[2,3,4], deadline:"Annual", description:"Mexico's oldest and most important arts festival. Commissions, residencies and awards for Mexican and Latin American artists.", url:"https://femsa.com/arte" },
  { id:19, type:"exhibition", name:"Salón ACME", org:"Salón ACME", city:"CDMX", country:"México", region:"mexico", duration:"Exhibition", stipend:false, fee:true, disciplines:["all"], levels:[1,2,3], deadline:"Annual", description:"Mexico City's largest artist-run art fair / open call. Key platform for emerging Mexican artists.", url:"https://salonacme.com" },
  { id:20, type:"exhibition", name:"ZONAMACO", org:"ZONAMACO", city:"CDMX", country:"México", region:"mexico", duration:"Fair", stipend:false, fee:true, disciplines:["all"], levels:[3,4,5], deadline:"Gallery-only", description:"Latin America's most important art fair. Gallery representation required. Key event for international exposure.", url:"https://zonamaco.com" },
  ...
  { id:25, type:"biennial",   name:"Venice Biennale", org:"La Biennale", city:"Venice", country:"Italy", region:"europe", duration:"6 months", stipend:true, fee:false, disciplines:["all"], levels:[5], deadline:"Nomination only", description:"The world's oldest and most prestigious art biennial. Nomination only.", url:"https://labiennale.org" },
  { id:26, type:"biennial",   name:"São Paulo Biennial", org:"Fundação Bienal", city:"São Paulo", country:"Brazil", region:"latin-america", duration:"3 months", stipend:true, fee:false, disciplines:["all"], levels:[4,5], deadline:"Nomination only", description:"One of the world's most important biennials. Strong Latin American focus.", url:"https://bienal.org.br" },
  ...
  { id:33, type:"residency",  name:"Bemis Center for Contemporary Arts", org:"Bemis Center", city:"Omaha", country:"USA", region:"north-america", duration:"2–6 months", stipend:true, fee:false, disciplines:["all"], levels:[2,3,4], deadline:"Rolling", description:"Fully funded residency with monthly stipend, studio, housing and exhibition opportunity.", url:"https://bemiscenter.org" },
  { id:34, type:"residency",  name:"Vermont Studio Center", org:"Vermont Studio Center", city:"Johnson", country:"USA", region:"north-america", duration:"4 weeks", stipend:false, fee:true, disciplines:["painting","drawing","sculpture","photography","installation"], levels:[1,2,3], deadline:"Rolling", description:"Largest international artist residency in the US. Community of 50+ artists simultaneously in residence.", url:"https://vermontstudiocenter.org" },
  { id:35, type:"residency",  name:"Rauschenberg Foundation Residency", org:"Rauschenberg Foundation", city:"Captiva Island", country:"USA", region:"north-america", duration:"3–5 weeks", stipend:true, fee:false, disciplines:["all"], levels:[3,4,5], deadline:"Annual", description:"Fully funded residency at Robert Rauschenberg's former home. Prestigious, experimental, multidisciplinary.", url:"https://rauschenbergfoundation.org" },
  { id:36, type:"residency",  name:"Künstlerhaus Bethanien", org:"Künstlerhaus Bethanien", city:"Berlin", country:"Germany", region:"europe", duration:"12 months", stipend:true, fee:false, disciplines:["all"], levels:[3,4], deadline:"Annual", description:"Prestigious Berlin residency. Studio, stipend, and solo exhibition at end of programme.", url:"https://bethanien.de" },
  { id:37, type:"residency",  name:"Gasworks Residency", org:"Gasworks", city:"London", country:"UK", region:"europe", duration:"3 months", stipend:true, fee:false, disciplines:["all"], levels:[2,3,4], deadline:"Rolling", description:"London residency with strong curatorial programme. Connected to Triangle Network internationally.", url:"https://gasworks.org.uk" },
  { id:38, type:"residency",  name:"Palais de Tokyo Residency", org:"Palais de Tokyo", city:"Paris", country:"France", region:"europe", duration:"3 months", stipend:true, fee:false, disciplines:["all"], levels:[3,4], deadline:"Annual", description:"Residency at one of Europe's most important contemporary art institutions. Strong visibility.", url:"https://palaisdetokyo.com" },
  ...
  { id:40, type:"residency",  name:"Residency Unlimited", org:"Residency Unlimited", city:"New York", country:"USA", region:"north-america", duration:"3–6 months", stipend:false, fee:false, disciplines:["all"], levels:[2,3,4], deadline:"Rolling", description:"NYC residency focused on international exchange. Connects artists to the New York art world.", url:"https://residencyunlimited.org" },
  ...
  { id:54, type:"grant",      name:"Mondriaan Fund", org:"Mondriaan Fund", city:"Amsterdam", country:"Netherlands", region:"europe", duration:"Project-based", stipend:true, fee:false, disciplines:["all"], levels:[2,3,4], deadline:"Rolling", description:"Dutch cultural fund. Production grants, residency support, and international presentation.", url:"https://mondriaanfonds.nl" },
  ...
  { id:63, type:"grant",      name:"Prince Claus Fund", org:"Prince Claus Fund", city:"Amsterdam", country:"Netherlands", region:"international", duration:"Award", stipend:true, fee:false, disciplines:["all"], levels:[3,4,5], deadline:"Nomination", description:"Awards for artists from Africa, Asia, Latin America and the Caribbean. €25,000. Nomination only.", url:"https://princeclausfund.org" },
  ...
  { id:72, type:"exhibition", name:"Premio Tamayo", org:"Museo Tamayo", city:"CDMX", country:"México", region:"mexico", duration:"Exhibition + Award", stipend:true, fee:false, disciplines:["all"], levels:[2,3,4], deadline:"Annual", description:"Mexico City's most important contemporary art prize. Exhibition at Museo Tamayo and cash prize.", url:"https://museotamayo.org" },
  ...
  { id:79, type:"fair",       name:"SP-Arte", org:"SP-Arte", city:"São Paulo", country:"Brazil", region:"latin-america", duration:"Fair", stipend:false, fee:true, disciplines:["all"], levels:[3,4,5], deadline:"Gallery-only", description:"Brazil's most important art fair. Strong Latin American collector base and growing international presence.", url:"https://sp-arte.com" },
  { id:80, type:"fair",       name:"arteBA", org:"arteBA Foundation", city:"Buenos Aires", country:"Argentina", region:"latin-america", duration:"Fair", stipend:false, fee:true, disciplines:["all"], levels:[2,3,4], deadline:"Gallery-only", description:"Argentina's leading art fair. Key platform for Latin American collectors and galleries.", url:"https://arteba.org" },
  { id:81, type:"fair",       name:"ARTBO", org:"ARTBO", city:"Bogotá", country:"Colombia", region:"latin-america", duration:"Fair", stipend:false, fee:true, disciplines:["all"], levels:[2,3,4], deadline:"Gallery-only", description:"Bogotá International Art Fair. Important platform for Colombian and Latin American art.", url:"https://artbo.co" },
